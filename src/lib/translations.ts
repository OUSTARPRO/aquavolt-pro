export const translations = {
  fr: {
    ...
    // Supplements / Orders
    supplementsManagement: "Commandes de compléments",
    catalogTab: "Catalogue",
    ordersTab: "Commandes",
    addSupplement: "Ajouter un produit",
    supplementName: "Nom du produit",
    supplementDesc: "Description",
    supplementUnit: "Unité",
    supplementCategory: "Catégorie",
    noSupplements: "Aucun produit dans le catalogue",
  ...
  ar: {
    ...
    // Supplements / Orders
    supplementsManagement: "طلبات المستلزمات",
    catalogTab: "الكتالوج",
    ordersTab: "الطلبات",
    addSupplement: "إضافة منتج",
    supplementName: "اسم المنتج",
    supplementDesc: "الوصف",
    supplementUnit: "الوحدة",
    supplementCategory: "الفئة",
    noSupplements: "لا توجد منتجات في الكتالوج",
    newOrder: "طلب جديد",

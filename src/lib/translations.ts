export const translations = {
  fr: {
    ...
    ordersManagement: "Commandes de compléments",
    productsCatalog: "Catalogue de compléments",
    ...
    selectProducts: "Sélectionnez les compléments",
    quantity: "Quantité",
    total: "Total",
    notes: "Notes",
    orderItems: "Produits",
  ...
  ar: {
    ...
    // Commandes de compléments
    ordersManagement: "طلبات المستلزمات",
    productsCatalog: "كتالوج المستلزمات",
    addProduct: "إضافة منتج",
    productName: "اسم المنتج",
    productNameAr: "الاسم (FR)",
    price: "الثمن (درهم)",
    newOrder: "طلب جديد",
    createOrder: "إنشاء الطلب",
    clientName: "اسم العميل",
    clientPhone: "هاتف العميل",
    selectProducts: "اختر المستلزمات",
    quantity: "الكمية",
    total: "المجموع",
    notes: "ملاحظات",
    orderItems: "المنتجات",
    noProducts: "لا توجد منتجات في الكتالوج",

export const translations = {
  fr: {
    ...
    // Complements / Orders
    complementsManagement: "Commandes Compléments",
    ...
    itemUnit: "Unité",
    submitOrder: "Enregistrer la commande",
    orderCreated: "Commande enregistrée avec succès",
    otherCategory: "Autre",
  },
  ar: {
    // Navigation
    ...
    orderStatus: "الحالة",
    orderDate: "التاريخ",
    orderPending: "في الانتظار",
    orderOrdered: "تم الطلب",
    ...
    orderCreated: "تم تسجيل الطلب بنجاح",
    otherCategory: "أخرى",
  },
} as const;

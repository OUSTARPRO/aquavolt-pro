export const translations = {
  ...
  ar: {
    ...
    // Supplies Orders
    suppliesManagement: "طلبات المستلزمات",
    addOrder: "طلب جديد",
    orderClientName: "اسم العميل",
    orderClientPhone: "الهاتف",
    orderClientCity: "المدينة",
    orderCategory: "الفئة",
    orderItems: "المواد المطلوبة",
    orderItemName: "المادة",
    orderItemQty: "الكمية",
    orderItemUnit: "الوحدة",
    orderItemRef: "المرجع",
    orderNotes: "ملاحظات",
    addItem: "إضافة مادة",
    removeItem: "حذف",
    ...
    orderLinkedQuote: "رقم عرض السعر المرتبط",
  },
} as const;
